...
def main():
    ...
    train_diff = pd.read_csv('/home/revujenation/PycharmProjects/Estagio_INESCTEC/summer_internship_dataset/train_diff0.csv')
    val_diff = pd.read_csv('/home/revujenation/PycharmProjects/Estagio_INESCTEC/summer_internship_dataset/val_diff0.csv')
    ...
    model = ResNet18(classes=12, input_shape=(224, 224, 3))

    # Add final layers
    #x = base_model.output
    #x = Flatten()(x)
    #predictions = Dense(12, kernel_regularizer=regularizers.l2(0.001), activation='softmax', name='fc1000')(x)
    ...
    # Save weights
    model.save_weights('diff0_dataset_weights.h5')
